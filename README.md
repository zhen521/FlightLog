...
### 🎨 主题系统
- **CRT雷达版暗黑荧光风主题** - 以黑底 + 亮黄系点缀为主的专业驾驶舱风格
- **智能主题切换** - 右上角一键切换亮色/暗色主题
- **完整颜色规范** - 基于 #1e1e1e 主背景和 #ffd65c 高亮色的完整配色系统
- **CRT扫描线效果** - 暗色主题下的科技感视觉特效
- **统一设计语言** - 所有UI元素采用4px统一圆角设计
- **Chart.js主题适配** - 图表颜色随主题自动调整
- **本地存储偏好** - 自动保存用户主题选择
...
- **Chart.js** - 数据可视化图表
- **CSS Variables** - 主题系统实现技术
- **LocalStorage** - 主题偏好本地存储
...
### 主题切换
1. 点击右上角的主题切换按钮（🌙 暗色 / ☀️ 亮色）
2. 享受**CRT雷达版暗黑荧光风**主题的科技感体验
3. 主题选择自动保存，下次访问自动恢复
